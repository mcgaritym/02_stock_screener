...
# -*- coding: utf-8 -*-
"""
Created on Thu May 27 23:21:35 2021
...
cnx = mysql.connector.connect(
        host = config_google.host,
        user = config_google.user,
        password = config_google.pwd)
...
engine = create_engine("mysql+mysqlconnector://{user}:{pwd}@{host}/{db_name}".format(
        host = config_google.host,
        user = config_google.user,
        pwd = config_google.pwd,
        db_name = config_google.db_name))
