...
def fin_news_scraper(*urls):
    ...
    for url in urls:
        ...
        print(response_delay, 10*response_delay)
        ...
        if 'msn' in url:
            ...
            for t in soup.find_all('span', class_ = 'title'):
                list_news.append(dict({'headline': t.text, 'org':'msnmoney', 'date': date_today}))               
            for t in soup.find_all('a', class_ = 'contentlink'):
                list_news.append(dict({'headline': t.h3.text, 'org':'msnmoney', 'date': date_today}))               
...
# =============================================================================
# get list of wayback url's from wayback machine scraper script, resample daily
# =============================================================================

file = glob.glob('wayback*.csv')
print(file)
for f in file:   
    df_wayback_url = pd.read_csv(f)
...
print('Runtime is: ', (time_2 - time_1)/60)
