...
tickers = yf.Tickers('fb aapl amzn nflx googl msft')
...
# fill in missing values with median for scikit learn
#close_prices_rolling = close_prices_rolling.fillna(np.nanmedian(close_prices_rolling))

# # define percent change to more easily visualize changes in price
def percent_change(values):
    prev_val = values.iloc[:-1]
